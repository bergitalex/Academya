...
generated_proverbs = []
while len(generated_proverbs) < num_proverbs:
    proverb = random.choice(proverbs)
    proverbs.remove(proverb)
    variant = random.choice(variants)
    variants.remove(variant)
    generated_proverb = proverb.replace("Ум", variant.capitalize())
    generated_proverbs.append(generated_proverb)
for idx, proverb in enumerate(generated_proverbs, start=1):
    print(f"{idx}. {proverb}")
